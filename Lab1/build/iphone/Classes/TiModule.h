...
/**
 The base class for all Lab1 modules
 */
...
/**
 Lab1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Lab1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Lab1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Lab1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Lab1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
