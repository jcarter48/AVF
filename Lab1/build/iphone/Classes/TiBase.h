...
// in simulator we redefine to format for Lab1 Developer console
...
{\
	NSString * exceptionName = [@"org.lab1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lab1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UILab1NativeItemNone = -1, 
	UILab1NativeItemSpinner = -2,
	UILab1NativeItemProgressBar = -3,
	
	UILab1NativeItemSlider = -4,
	UILab1NativeItemSwitch = -5,
	UILab1NativeItemMultiButton = -6,
	UILab1NativeItemSegmented = -7,
	
	UILab1NativeItemTextView = -8,
	UILab1NativeItemTextField = -9,
	UILab1NativeItemSearchBar = -10,
	
	UILab1NativeItemPicker = -11,
	UILab1NativeItemDatePicker = -12,
	
	UILab1NativeItemInfoLight = -13,
	UILab1NativeItemInfoDark = -14,
	
	UILab1NativeItemDisclosure = -15,
	
	UILab1NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Lab1 instances of
