...
/**
 The base class for all Lecture1 modules
 */
...
/**
 Lecture1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Lecture1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Lecture1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Lecture1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Lecture1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
