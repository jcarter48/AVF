...
//@interface Lecture1Object : NSObject
//@end

@interface Lecture1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Lecture1Object class]])
		{
			for (NSString *key in [[(Lecture1Object*)o modules] allKeys])
			{
