...
// in simulator we redefine to format for Lecture1 Developer console
...
{\
	NSString * exceptionName = [@"org.lecture1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lecture1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UILecture1NativeItemNone = -1, 
	UILecture1NativeItemSpinner = -2,
	UILecture1NativeItemProgressBar = -3,
	
	UILecture1NativeItemSlider = -4,
	UILecture1NativeItemSwitch = -5,
	UILecture1NativeItemMultiButton = -6,
	UILecture1NativeItemSegmented = -7,
	
	UILecture1NativeItemTextView = -8,
	UILecture1NativeItemTextField = -9,
	UILecture1NativeItemSearchBar = -10,
	
	UILecture1NativeItemPicker = -11,
	UILecture1NativeItemDatePicker = -12,
	
	UILecture1NativeItemInfoLight = -13,
	UILecture1NativeItemInfoDark = -14,
	
	UILecture1NativeItemDisclosure = -15,
	
	UILecture1NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Lecture1 instances of
