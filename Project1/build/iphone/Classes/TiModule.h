...
/**
 The base class for all Project1 modules
 */
...
/**
 Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
